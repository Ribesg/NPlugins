...
public enum FlagAtt {
    ...
    // Integer
    HEAL_AMOUNT, HEAL_TIMER, HEAL_MIN_HEALTH, HEAL_MAX_HEALTH, FEED_AMOUNT, FEED_TIMER, FEED_MIN_FOOD, FEED_MAX_FOOD, EXPLOSION_BLOCK_DROP,

    // Location
    EXTERNAL_POINT, INTERNAL_POINT,
