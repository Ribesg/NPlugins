...
public class Messages extends AbstractMessages {
    ...
    protected Set<Message> createMessage() {
        ...
        newMessages.add(new Message(MessageId.theEndAgain_incorrectValueInConfiguration, "&cIncorrect value in configuration %filename% : \"%value%\" was restored to default (%default%)", new String[] { "%filename%", "%value%", "%default%" }, null));
