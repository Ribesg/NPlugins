...
public class Messages extends AbstractMessages {
	...
	protected Set<Message> createMessage() {
		...
		// Command - END
		newMessages.add(new Message(MessageId.theEndAgain_unkownSubCmd, "&cUnknown sub-command: %arg%", new String[] {"%arg%"}, null, true));
		newMessages.add(new Message(MessageId.theEndAgain_regenerating, "&aRegeneration of world %world% in progress", new String[] {"%world%"}, null, true));
		newMessages.add(new Message(MessageId.theEndAgain_respawned1, "&aAn EnderDragon has been respawned in world %world%", new String[] {"%world%"}, null, true));
		newMessages.add(new Message(MessageId.theEndAgain_respawnedX, "&a%nb% EnderDragons have been respawned in world %world%", new String[] {
				"%nb%",
				"%world%"
		}, null, true));
		newMessages.add(new Message(MessageId.theEndAgain_nbAlive0, "&aThere is no EnderDragon alive in world %world%", new String[] {"%world%"}, null, true));
		newMessages.add(new Message(MessageId.theEndAgain_nbAlive1, "&aThere is 1 EnderDragon alive in world %world%", new String[] {"%world%"}, null, true));
		newMessages.add(new Message(MessageId.theEndAgain_nbAliveX, "&aThere are %nb% EnderDragons alive in world %world%", new String[] {
				"%nb%",
				"%world%"
		}, null, true));
		newMessages.add(new Message(MessageId.theEndAgain_notInAnEndWorld, "&cYou're not in an End world, please provide an End world name.", null, null, true));

		newMessages.add(new Message(MessageId.theEndAgain_protectedChunkInfo, "&aChunk (&6%x%&a,&6%z%&a) in world &6%world% &ais protected", new String[] {
				"%x%",
				"%z%",
				"%world%"
		}, null, true));
		newMessages.add(new Message(MessageId.theEndAgain_protectedChunkProtect, "&cChunk (&6%x%&c,&6%z%&c) in world &6%world% &cis already protected", new String[] {
				"%x%",
				"%z%",
				"%world%"
		}, null, true));
		newMessages.add(new Message(MessageId.theEndAgain_protectedChunkUnprotect, "&aChunk (&6%x%&a,&6%z%&a) in world &6%world% &ais no longer protected", new String[] {
				"%x%",
				"%z%",
				"%world%"
		}, null, true));

		newMessages.add(new Message(MessageId.theEndAgain_unprotectedChunkInfo, "&aChunk (&6%x%&a,&6%z%&a) in world &6%world% &ais not protected", new String[] {
				"%x%",
				"%z%",
				"%world%"
		}, null, true));
		newMessages.add(new Message(MessageId.theEndAgain_unprotectedChunkProtect, "&aChunk (&6%x%&a,&6%z%&a) in world &6%world% &ais now protected", new String[] {
				"%x%",
				"%z%",
				"%world%"
		}, null, true));
		newMessages.add(new Message(MessageId.theEndAgain_unprotectedChunkUnprotect, "&cChunk (&6%x%&c,&6%z%&c) in world &6%world% &cis already not protected", new String[] {
				"%x%",
				"%z%",
				"%world%"
		}, null, true));
