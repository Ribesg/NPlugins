...
public class Messages extends AbstractMessages {
    ...
    protected Set<Message> createMessage() {
        ...
        // Command - NICK
        newMessages.add(new Message(MessageId.talk_youNickNamed, "&aYou renamed %realName% %nickName%", new String[] { "%realName%", "%nickName%" }, null));
        newMessages.add(new Message(MessageId.talk_youDeNickNamed, "&aYou reseted the name of %realName%", new String[] { "%realName%" }, null));
        newMessages.add(new Message(MessageId.talk_youWereNickNamed, "&aYou were renamed %nickName% by %playerName%", new String[] { "%nickName%", "%playerName%" }, null));
        newMessages.add(new Message(MessageId.talk_youWereDeNickNamed, "&aYour name was reseted by %playerName%", new String[] { "%playerName%" }, null));
